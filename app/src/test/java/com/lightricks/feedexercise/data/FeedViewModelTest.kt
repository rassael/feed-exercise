...
class FeedViewModelTest {
    ...
    // for getting liveData's value in the test
    ...
    fun testGetItems_emptyList(): Unit = runTest {
        ...
        Assert.assertEquals(listOf<FeedItem>(), viewModel.getFeedItems().getOrAwaitValue())
    }
...
fun getAllItems(): List<FeedItem> {
    ...
    return adapter.fromJson("{\n" +
            ...
            "    }\n" +
            "  ]\n" +
            "}\n")?.itemDto?.toEntities()?.toFeedItems() ?: emptyList()
}
